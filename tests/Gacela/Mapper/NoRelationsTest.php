...
class NoRelationsTest extends \Test\TestCase
{
	/**
	...
	{
		$this->assertAttributeEquals($data, '_data', \Gacela\Gacela::instance()->loadMapper($mapper)->load($data));
	}
	...
	{
		$mapper = \Gacela\Gacela::instance()->loadMapper('Test\Mapper\Test');
